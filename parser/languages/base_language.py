...
class LanguageCustomizations(ABC):
    """Base class for language-specific customizations"""

    @abstractmethod
    def apply_customizations(self, verses, document):
        """Apply language-specific customizations to parsed verses"""
        pass
